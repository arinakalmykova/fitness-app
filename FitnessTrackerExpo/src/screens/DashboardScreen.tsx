  ...
  return (
    ...
    >
      ...
      <View style={styles.stats}>
        <View
          style={[styles.statsItem, { backgroundColor: theme.colors.card }]}
        >
          <Text style={[{ color: theme.colors.text }, theme.fonts.text]}>
            Всего тренировок
          </Text>
          <Text style={[styles.statsNumbers, theme.fonts.h1]}>
            {stats?.numberWorkout}
          </Text>
        </View>
        <View
      ...
      <Text
        style={[styles.textRight, theme.fonts.text]}
